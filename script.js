...
function renderAreaFilter() {
  ...
  areaFilter.value = areas.includes(current) ? current : "all";
}
...
function getVisibleReviews() {
  ...
  filtered.sort((a, b) => {
    ...
    if (sort === "area") return a.area.localeCompare(b.area) || a.location.localeCompare(b.location);
...
[searchInput, areaFilter, sortSelect].forEach((element) => {
